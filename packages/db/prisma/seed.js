...
const KEYWORD_TEMPLATES = {
    colonialism: {
        ...
        summary: (title, note) => `Watch how ${title} maps empire versus periphery${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Notice diplomacy, tribute, and coded resistance${focus ? ` (${focus})` : ""}.`,
        colorHint: "#c47f17"
    },
    identity: {
        ...
        summary: (title, note) => `Consider how ${title} asks characters to negotiate who they are${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Track aliases, code-switching, and chosen names${focus ? ` (${focus})` : ""}.`,
        colorHint: "#9c27b0"
    },
    memory: {
        ...
        summary: (title, note) => `Observe how ${title} treats memory as power${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Log objects, songs, or rituals that hold the past${focus ? ` (${focus})` : ""}.`,
        colorHint: "#5d4037"
    },
    "political-intrigue": {
        ...
        summary: (title, note) => `Map the alliances and betrayals that drive ${title}${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Flag council scenes, coded poetry, or informal deals${focus ? ` (${focus})` : ""}.`,
        colorHint: "#37474f"
    },
    language: {
        ...
        summary: (title, note) => `Examine how ${title} uses language as leverage${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Note idioms, borrowed scripts, and translation mishaps${focus ? ` (${focus})` : ""}.`,
        colorHint: "#0c7cd5"
    },
    ecology: {
        ...
        summary: (title, note) => `Watch how ${title} ties character choices to ecosystems${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Mark recurring weather, flora, and resource metaphors${focus ? ` (${focus})` : ""}.`,
        colorHint: "#2e7d32"
    },
    climate: {
        ...
        summary: (title, note) => `Consider how ${title} imagines communities responding to climate strain${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Pay attention to migration choices, rationing, and shared shelters${focus ? ` (${focus})` : ""}.`,
        colorHint: "#0277bd"
    },
    technology: {
        ...
        summary: (title, note) => `Notice how ${title} frames invention as both promise and threat${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Trace labs, prototypes, and the ethics they spark${focus ? ` (${focus})` : ""}.`,
        colorHint: "#424242"
    },
    "ai-ethics": {
        ...
        summary: (title, note) => `Interrogate how ${title} distributes agency between humans and machines${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Spot consent checks, override clauses, and the emotional labor handed to AI${focus ? ` (${focus})` : ""}.`,
        colorHint: "#546e7a"
    },
    rebellion: {
        ...
        summary: (title, note) => `Follow how ${title} depicts coalition building${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Flag secret meetings, coded art, and shifts in morale${focus ? ` (${focus})` : ""}.`,
        colorHint: "#bf360c"
    },
    authoritarianism: {
        ...
        summary: (title, note) => `Examine how ${title} shows power consolidating${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Track curfews, censorship, and loyalty rituals${focus ? ` (${focus})` : ""}.`,
        colorHint: "#880e4f"
    },
    prophecy: {
        name: "Prophecy & Fate",
        ...
        summary: (title, note) => `Consider how ${title} balances destiny with agency${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Watch for dreams, auguries, and who chooses to believe${focus ? ` (${focus})` : ""}.`,
        colorHint: "#6a1b9a"
    },
    religion: {
        name: "Faith & Ritual",
        ...
        summary: (title, note) => `Observe how ${title} stages worship, doubt, and community${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Track temples, songs, and taboos${focus ? ` (${focus})` : ""}.`,
        colorHint: "#f57f17"
    },
    myth: {
        name: "Myth & Retelling",
        ...
        summary: (title, note) => `See how ${title} converses with older stories${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Log invocations, heroic epithets, and subverted archetypes${focus ? ` (${focus})` : ""}.`,
        colorHint: "#ff7043"
    },
    trauma: {
        ...
        summary: (title, note) => `Notice how ${title} acknowledges harm and recovery${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Trace grounding rituals, flashbacks, and trusted confidants${focus ? ` (${focus})` : ""}.`,
        colorHint: "#ad1457"
    },
    healing: {
        ...
        summary: (title, note) => `Watch how ${title} invests in healing practices${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Mark shared meals, creative play, and intergenerational teaching${focus ? ` (${focus})` : ""}.`,
        colorHint: "#66bb6a"
    },
    "found-family": {
        name: "Found Family",
        ...
        summary: (title, note) => `Follow how ${title} builds trust between unlikely allies${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Track acts of service, inside jokes, and defense of group boundaries${focus ? ` (${focus})` : ""}.`,
        colorHint: "#1e88e5"
    },
    class: {
        name: "Class & Labor",
        ...
        summary: (title, note) => `Consider how ${title} surfaces labor politics${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Note uniforms, tipping rituals, and whose work is considered noble${focus ? ` (${focus})` : ""}.`,
        colorHint: "#795548"
    },
    surveillance: {
        name: "Surveillance",
        ...
        summary: (title, note) => `Examine how ${title} imagines being seen or recorded${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Highlight security feeds, notebooks, or prophetic visions used as intel${focus ? ` (${focus})` : ""}.`,
        colorHint: "#263238"
    },
    gender: {
        ...
        summary: (title, note) => `Track how ${title} plays with gendered expectations${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Notice clothing, pronoun shifts, and bodily autonomy debates${focus ? ` (${focus})` : ""}.`,
        colorHint: "#ec407a"
    },
    migration: {
        ...
        summary: (title, note) => `Consider how ${title} frames movement and belonging${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Mark border crossings, letters home, and remittance negotiations${focus ? ` (${focus})` : ""}.`,
        colorHint: "#00897b"
    },
    resilience: {
        ...
        summary: (title, note) => `Notice where ${title} makes space for hope${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Track moments of laughter, art, and shared vision boards${focus ? ` (${focus})` : ""}.`,
        colorHint: "#ffca28"
    },
    time: {
        name: "Time & Structure",
        ...
        summary: (title, note) => `Watch how ${title} bends timelines${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Map flashbacks, nested tales, and foreshadowing experiments${focus ? ` (${focus})` : ""}.`,
        colorHint: "#3f51b5"
    },
    storytelling: {
        ...
        summary: (title, note) => `Consider who narrates ${title} and why${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Note frame narratives, unreliable guides, and contested sources${focus ? ` (${focus})` : ""}.`,
        colorHint: "#a1887f"
    },
    "war-ethics": {
        name: "War & Ethics",
        ...
        summary: (title, note) => `Analyze how ${title} justifies violence${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Flag command briefings, oaths, and dissenting officers${focus ? ` (${focus})` : ""}.`,
        colorHint: "#b71c1c"
    },
    hope: {
        ...
        summary: (title, note) => `Pay attention to how ${title} insists on care${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Mark resource sharing, public art, and stubborn joy${focus ? ` (${focus})` : ""}.`,
        colorHint: "#ff8f00"
    },
    grief: {
        ...
        summary: (title, note) => `Notice how ${title} honors the dead${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Track wakes, memorial art, and conflicting stories about loss${focus ? ` (${focus})` : ""}.`,
        colorHint: "#455a64"
    },
    "magic-systems": {
        name: "Magic Systems",
        ...
        summary: (title, note) => `Look at how ${title} defines power limits${note ? ` — ${note}` : ""}.`,
        watchFor: (focus) => `Catalog ingredients, oaths, and the price each casting demands${focus ? ` (${focus})` : ""}.`,
        colorHint: "#ab47bc"
    }
};
const GENRE_CATALOG = {
...
const SERIES = [
        ...
        books: [
            {
                ...
                synopsis: "Mahit Dzmare is dispatched from a tiny mining station to navigate the poetry-soaked empire that threatens to absorb her home.",
                publishedYear: 2019,
            ...
            },
            {
                ...
                synopsis: "Teixcalaan faces an unknowable foe, while Mahit and Three Seagrass test the limits of diplomacy, translation, and trust.",
                publishedYear: 2021,
                genres: ["science-fiction", "space-opera", "political-thriller"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "On a continent wracked by apocalyptic Seasons, three orogenes fight for survival and a future where their power is not shackled.",
                publishedYear: 2015,
            ...
            },
            {
                ...
                synopsis: "Essun trains within Castrima's hollow geode while Nassun learns what obedience costs, and obelisks stir above them both.",
                publishedYear: 2016,
                genres: ["science-fiction", "fantasy", "cli-fi"],
                preps: [
                    {
            ...
            {
                title: "The Stone Sky",
                synopsis: "Mother and daughter race toward Corepoint to end the cyclical Seasons, forcing a reckoning with Hoa's long-guarded past.",
                publishedYear: 2017,
                genres: ["science-fiction", "fantasy", "cli-fi"],
                preps: [
                    {
            ...
            },
            {
                ...
                synopsis: "New York's borough avatars wake up to fight interdimensional colonization with graffiti, math, and mutual aid.",
                publishedYear: 2020,
        ...
        books: [
            {
                ...
                synopsis: "Envoy Genly Ai must learn trust on Gethen, where gender shifts with the cycle of kemmer and loyalty is measured in snowstorms.",
                publishedYear: 1969,
            ...
            },
            {
                ...
                synopsis: "Physicist Shevek travels from the anarchist moon Anarres to the capitalist planet Urras seeking a way to share his General Temporal Theory.",
                publishedYear: 1974,
    ...
    },
    {
        ...
        books: [
            {
                title: "Dune",
                synopsis: "Paul Atreides is thrust into the politics of Arrakis, where spice, prophecy, and ecology converge.",
                publishedYear: 1965,
            ...
            {
                title: "Dune Messiah",
                synopsis: "Years into Paul's reign, conspirators test how far a messiah can fall without losing absolute power.",
                publishedYear: 1969,
            ...
            },
            {
                ...
                synopsis: "Leto II and Ghanima inherit an empire at risk of stagnation, forcing metamorphosis.",
                publishedYear: 1976,
                genres: ["science-fiction", "space-opera"],
                preps: [
                    {
    ...
    },
    {
        ...
        books: [
            {
                title: "Kindred",
                synopsis: "Dana Franklin is yanked through time to save an ancestor in antebellum Maryland, confronting the mechanics of survival under slavery.",
                publishedYear: 1979,
            ...
            },
            {
                ...
                synopsis: "Lauren Olamina flees a collapsing walled community and nurtures Earthseed amid climate chaos.",
                publishedYear: 1993,
            ...
            },
            {
                ...
                synopsis: "Earthseed confronts a theocratic president, testing whether destiny can include the stars.",
                publishedYear: 1998,
                genres: ["science-fiction", "cli-fi", "dystopian"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "Breq, once a troopship AI, hunts the Radch ruler responsible for fracturing her mind.",
                publishedYear: 2013,
                genres: ["science-fiction", "space-opera", "political-thriller"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "Holden and Miller investigate a disappearing freighter and uncover the protomolecule.",
                publishedYear: 2011,
            ...
            {
                title: "Caliban's War",
                synopsis: "OPA tensions spike as a protomolecule super soldier threatens Ganymede's children.",
                publishedYear: 2012,
                genres: ["science-fiction", "space-opera", "military-sf"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "Two magicians revive English magic and unleash the Gentleman with Thistledown Hair.",
                publishedYear: 2004,
        ...
        books: [
            {
                ...
                synopsis: "A traveling circus becomes the stage for a decades-long magical duel that blooms into collaboration.",
                publishedYear: 2011,
        ...
        books: [
            {
                ...
                synopsis: "A traveling symphony performs Shakespeare in the aftermath of a pandemic, linking actors, artists, and archivists.",
                publishedYear: 2014,
            ...
            },
            {
                ...
                synopsis: "Time anomalies connect a 1912 exile, a novelist, a detective, and a lunar colony.",
                publishedYear: 2022,
        ...
        books: [
            {
                ...
                synopsis: "Secret projects in Cultural Revolution China contact the Trisolaran civilization.",
                publishedYear: 2006,
            ...
            },
            {
                ...
                synopsis: "Earth builds deterrents while Trisolaris dispatches sophons to surveil humanity.",
                publishedYear: 2008,
            ...
            {
                title: "Death's End",
                synopsis: "The Trisolaran crisis expands into cosmic-scale warfare and dimensional weapons.",
                publishedYear: 2010,
                genres: ["science-fiction", "philosophical-sf"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "Kvothe recounts his childhood, the Chandrian attack, and his first years at the University.",
                publishedYear: 2007,
            ...
            },
            {
                ...
                synopsis: "Kvothe travels beyond the University, confronting the Adem, Felurian, and Maer's court.",
                publishedYear: 2011,
                genres: ["fantasy", "epic-fantasy"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "Kaladin, Shallan, and Dalinar navigate war on the Shattered Plains while spren awaken.",
                publishedYear: 2010,
                genres: ["fantasy", "epic-fantasy"],
                preps: [
                    {
            ...
            {
                title: "Rhythm of War",
                synopsis: "Humans and singers experiment with fabrials and rhythms while Navani redefines scholarship.",
                publishedYear: 2020,
                genres: ["fantasy", "epic-fantasy"],
                preps: [
                    {
    ...
    },
    {
        ...
        books: [
            ...
            },
            {
                ...
                synopsis: "The War of the Ring ends with sacrifice, coronation, and bittersweet departures.",
                publishedYear: 1955,
                genres: ["fantasy", "epic-fantasy"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "Pip rises from the forge dreaming of gentility, only to learn the cost of snobbery.",
                publishedYear: 1861,
                genres: ["literary-fiction", "historical-fiction"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "In Gilead, women are conscripted as handmaids and Offred remembers life before the coup.",
                publishedYear: 1985,
    ...
    },
    {
        ...
        books: [
            {
                title: "Beloved",
                synopsis: "Haunted by the daughter she killed, Sethe must face memory, community, and love.",
                publishedYear: 1987,
                genres: ["literary-fiction", "historical-fiction"],
                preps: [
                    {
        ...
        books: [
            {
                ...
                synopsis: "Okonkwo's rise and fall parallels the arrival of British colonial rule in Umuofia.",
                publishedYear: 1958,
        ...
        books: [
            {
                ...
                synopsis: "Celie writes letters to God and her sister while reclaiming her life in the rural South.",
                publishedYear: 1982,
                genres: ["literary-fiction", "historical-fiction"],
                preps: [
                    {
    ...
    },
    {
        ...
        books: [
            {
                title: "American Gods",
                synopsis: "Shadow Moon escorts the trickster Mr. Wednesday across America as old gods battle newcomers.",
                publishedYear: 2001,
            ...
            {
                title: "Neverwhere",
                synopsis: "Richard Mayhew slips into London Below, a city of forgotten people and dangerous angels.",
                publishedYear: 1996,
    ...
    },
    {
        ...
        books: [
            {
                title: "Good Omens",
                synopsis: "An angel and a demon team up to stop the apocalypse with help from a misplaced Antichrist.",
                publishedYear: 1990,
        ...
        books: [
            {
                ...
                synopsis: "William Mandella fights an interstellar war where relativity disconnects him from home.",
                publishedYear: 1974,
    ...
    },
    {
        ...
        books: [
            {
                title: "Contact",
                synopsis: "SETI scientist Ellie Arroway decodes a message leading to an interstellar meeting.",
                publishedYear: 1985,
    ...
    },
    {
        ...
        books: [
            {
                title: "The Poppy War",
                synopsis: "Rin rises from poverty to the Sinegard Academy, unlocking shamanic power amid genocidal war.",
                publishedYear: 2018,
            ...
            {
                title: "Babel",
                synopsis: "Robin Swift studies translation magic at Oxford, confronting colonial extraction.",
                publishedYear: 2022,
                genres: ["fantasy", "historical-fiction", "literary-fiction"],
                preps: [
                    {
    ...
    },
    {
        ...
        books: [
            {
                title: "Homegoing",
                synopsis: "Two half sisters and their descendants experience divergent histories across Ghana and the United States.",
                publishedYear: 2016,
                genres: ["literary-fiction", "historical-fiction"],
                preps: [
                    {
...
const BOOKS = SERIES.flatMap((series) => series.books.map((book) => ({
    ...book,
...
async function main() {
    ...
    const usedGenres = new Set(BOOKS.flatMap((book) => book.genres));
    ...
    for (const [slug, template] of Object.entries(KEYWORD_TEMPLATES)) {
    ...
    for (const book of BOOKS) {
        ...
        for (const prep of book.preps) {
            ...
            const keywordSlugs = new Set([prep.keyword, ...(prep.extraKeywords ?? [])]);
